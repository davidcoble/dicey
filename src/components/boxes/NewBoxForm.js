...
export default class NewBoxForm extends React.Component {
    constructor(props) {
        super(props);
        const bid = props.box ? props.box.id : uuid();
        this.state = {
            bid,
    ...
    render() {
        console.log("about to create a new box with id = " + this.state.bid);
        return (
